  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/counter-conduct-magazine-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/counter-conduct-magazine-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build counter-conduct-magazine-style-guide.gemspec && mv counter-conduct-magazine-style-guide-' + userConfig.client.version + '.gem ../counter-conduct-magazine-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install counter-conduct-magazine-style-guide-' + userConfig.client.version + '.gem && rm counter-conduct-magazine-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
